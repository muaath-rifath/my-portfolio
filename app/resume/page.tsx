...
export const metadata: Metadata = {
  ...
  description: "View and download the resume of Mohamed Muaath Rifath, a Software Engineer specializing in scalable backends, AI-integrated frontends, and modern web development.",
